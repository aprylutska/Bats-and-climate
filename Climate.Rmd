...
```{r} 
mod <- lm(Ra ~ day, data=subset(df,Year == '2011'))
summary (mod)                                            
plot(mod)
ggplot(data = subset(df,Year == '2011'), aes(x = day, y = Ra)) +
  geom_point() +
  geom_smooth(method = "lm") 

ggplot(data=subset(df,Year == '2011'), aes (x = Ra)) +
  geom_histogram()
```


```{r} 
mod <- lm(Ra ~ day, data=subset(df,Year == '2014'))
summary (mod)                                            
plot(mod)
ggplot(data = subset(df,Year == '2014'), aes(x = day, y = Ra)) +
  geom_point() +
  geom_smooth(method = "lm") 

ggplot(data=subset(df,Year == '2014'), aes (x = Ra)) +
  geom_histogram()
```
...
```{r} 
mod <- lm(Ra ~ day, data=subset(df,Year == '2019'))
summary (mod)                                            
plot(mod)
ggplot(data = subset(df,Year == '2019'), aes(x = day, y = Ra)) +
  geom_point() +
  geom_smooth(method = "lm") 

ggplot(data=subset(df,Year == '2019'), aes (x = Ra)) +
  geom_histogram()
```
