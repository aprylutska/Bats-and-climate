...
# Monthly climate
Here we explore the relationship among bat forearm length, weight, and Body Mass Index and simplest possible aggregated climatic variables - average mean temperature, average minimal temperature, and precipitation. Time period for aggregation - one calendar month.
