...
modeldir <- "./models_1000rep_23w_absW_nnoc/"
figuredir <- "./figures_1000rep_23w_absW_nnoc/"
...
for (i in 1:(length(RaWin)-1)) {
  ...
  png(paste0(figuredir, "climwin_Ra_Prcp_", RaWin$combos$climate[i], ".png"), width = 32 , height = 22, 
      units = "cm", res = 300)
  plotall(dataset = RaOutput,
          datasetrand = RaRand_data,
          bestmodel = RaSingle$BestModel,
...
for (i in 1:(length(WWin)-1)) {
  ...
  png(paste0(figuredir, "climwin_W_Prcp_", WWin$combos$climate[i], ".png"), width = 32 , height = 22, 
      units = "cm", res = 300)
  plotall(dataset = RaOutput,
          datasetrand = WRand_data,
          bestmodel = RaSingle$BestModel,
...
for (i in 1:(length(BMIWin)-1)) {
  ...
  png(paste0(figuredir, "climwin_BMI_Prcp_", BMIWin$combos$climate[i], ".png"), width = 32 , height = 22, 
      units = "cm", res = 300)
  plotall(dataset = RaOutput,
          datasetrand = BMIRand_data,
          bestmodel = RaSingle$BestModel,
